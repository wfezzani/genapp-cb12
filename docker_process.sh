...
sudo podman cp $WA_SRC_FOLDER/genapp-cb12/project_process.sh GENAPP-$CI_PIPELINE_ID:$WA_DST_FOLDER
#sudo podman exec -e AZN_API_SERVER_PORT=$port2 GENAPP-$CI_PIPELINE_ID env
sudo podman exec GENAPP-$CI_PIPELINE_ID chmod 777 /home/wazi/data/project/project_process.sh
sudo podman exec GENAPP-$CI_PIPELINE_ID /home/wazi/data/project/project_process.sh
